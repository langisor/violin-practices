...
const EXERCISES: Exercise[] = [
  { n: 1, title: "Long Bow", note: "One full slow bow per half note, all down-bow direction." },
  { n: 2, title: "Half Bow", note: "Same scale, half-length bow strokes." },
  { n: 3, title: "Long–Half, Half", note: "One long stroke followed by two half strokes." },
  { n: 4, title: "Half, Half–Long", note: "Two half strokes followed by one long stroke." },
  { n: 5, title: "Half Bow", note: "Mixed rhythm, short-bow discipline." },
  { n: 6, title: "Slow, Long Bow", note: "Whole notes — one bow per measure, ultimate tone drill." },
  { n: 7, title: "Full Bow", note: "Alternating down/up, quarter notes, full bow length." },
  { n: 8, title: "Full Bow", note: "Consecutive same-direction strokes — clean retakes." },
  { n: 9, title: "Full Bow — down only", note: "All down-bow, reset to frog between notes." },
  { n: 10, title: "Full Bow — up only", note: "All up-bow, reset to tip between notes." },
  { n: 11, title: "Full Bow — up only", note: "Up-bow with phrase grouping." },
  { n: 12, title: "Full Bow — down only", note: "Down-bow with phrase grouping." },
  { n: 13, title: "Full Bow — down only", note: "Extended down-bow stamina passage." },
  { n: 14, title: "Short Bow", note: "Fast even eighth notes, short strokes." },
  { n: 15, title: "Short×4 – Long", note: "Four short strokes into one long stroke." },
  { n: 16, title: "Short, Short – Half", note: "Paired short strokes resolving to a half stroke." },
  { n: 17, title: "Half – Short, Short", note: "Half stroke followed by paired short strokes." },
  { n: 18, title: "Short, Short – Half", note: "Variant grouping of the same pattern." },
  { n: 19, title: "Short×4 – Long", note: "Repeats pattern of No. 15 with new bowing marks." },
  { n: 20, title: "Long – Short×4", note: "Long stroke opens, then four short strokes." },
  { n: 21, title: "Long – Short, Short – Long", note: "Symmetrical long/short/long grouping." },
  { n: 22, title: "Long – Short, Short – Long", note: "Continues symmetrical grouping." },
  { n: 23, title: "Full Bow", note: "Alternating full bow across the octave." },
  { n: 24, title: "Short×4 – Long", note: "Fast group into sustained note." },
  { n: 25, title: "Full Bow Staccato", note: "Detached, articulated strokes, same direction groups." },
  { n: 26, title: "Full Bow Staccato – Legato", note: "Alternates staccato groups with smooth legato." },
  { n: 27, title: "Full Bow Staccato", note: "Up-bow staccato groups." },
  { n: 28, title: "Full Bow Staccato – Legato", note: "Up-bow staccato into legato phrasing." },
  { n: 29, title: "Full Bow", note: "Steady alternating full-bow scale." },
  { n: 30, title: "Full Bow", note: "Continues full-bow alternation." },
  { n: 31, title: "Full Bow", note: "Extended grouped pattern, longer phrase." },
  { n: 32, title: "Full Bow", note: "Dotted rhythm full-bow pattern." },
  { n: 33, title: "Short Bow", note: "Fast even short strokes, both directions." },
  { n: 34, title: "Full Bow — accented", note: "Marcato accents on each down-bow." },
  { n: 35, title: "Full Bow", note: "Closing scale pattern, relaxed tone." },
];
...
export default function ViolinPracticeTracker() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const result = await (window as unknown as Window & { storage: AppStorage }).storage.get(STORAGE_KEY);
  ...
  const persist = async (next: PracticeLog) => {
    setLog(next);
    try {
      await (window as unknown as Window & { storage: AppStorage }).storage.set(
        STORAGE_KEY,
        JSON.stringify(next)
      );
    } catch {
